...
void send_msg(int client_sock) { // send to all
	...
	char contenttype[] = "Content-Type:text/html\r\n";
	char html[] = "<!DOCTYPE html><html><head><title>ass07</title></head><body><H1> hello,world! </H1>\
<br><button type = \"button\">GET</button><button type = \"button\">POST</button></body></html>\r\n";
	char end[]="\r\n";
